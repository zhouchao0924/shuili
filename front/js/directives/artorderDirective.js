...
MetronicApp.directive('productSelectModal', ['queryBrand1', 'ajax1', function(queryBrand1, ajax1) {
    var linker = function(scope, elem, attrs, ctrl) {
        ...
        var queryUrl = scope.queryUrl ? scope.queryUrl : '/art/queryArtList/';
        scope.types = [];
        scope.brands = [];
                    ...
                    success: function(datas) {
                        if (datas.code == 1) {
                            ...
                            $.each(datas.obj.list, function(i, n) {
                                ...
                                //         }
                                //     })
                                var temp = ['', n.artId, n.artName, n.displayProductSubType, n.nickName, n.roomValues];
    ...
    return {
        ...
        templateUrl: 'tpl/artordermodalProductSelect.html',
        link: linker
    };
}]);
