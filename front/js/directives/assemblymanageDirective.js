MetronicApp.directive('tableTab5', ['dataTable3', '$timeout', 'queryFilter', '$compile', 'userNow',
    function(dataTable3, $timeout, queryFilter, $compile, userNow) {
        return {
            restrict: 'E',
            templateUrl: 'tpl/assemblymanagetableTab.html',
            // require: 'ngModel',
            scope: {
                tableParams: '=',
                tables: '=',
            ...
            link: function(scope, elem, attrs) {
                ...
                scope.click0 = function() {
                    ...
                    if (!table0) {
                        ...
                        scope.tables[0] = table0 = dataTable3.new(tableParams, scope);
                    } else {
                ...
                scope.click1 = function() {
                    ...
                    if (!table1) {
                        ...
                        scope.tables[1] = table1 = dataTable3.new(tableParams, scope);
                    } else {
                ...
                scope.click2 = function() {
                    ...
                    if (!table2) {
                        ...
                        scope.tables[2] = table2 = dataTable3.new(tableParams, scope);
                    } else {
                ...
                scope.click3 = function() {
                    ...
                    if (!table3) {
                        ...
                        tableParams.conditions = scope.$parent.searchDetail;
                        scope.tables[3] = table3 = dataTable3.new(tableParams, scope);
                    } else {
