//进销存商品选择弹出框
MetronicApp.directive('invoicingSplitStock', ['$timeout', function($timeout) {
    return {
        restrict: 'E',
        // require: '?ngModel',
        // transclude: true,
        ...
        templateUrl: 'tpl/invoicingSplitStock.html',
        link: function(scope, elem, attrs, ctrl) {
            scope.isChecked = function() {
                var result = false
                return scope.productList && scope.productList.some(function(e) {
                    return e.checked
                })
            }
