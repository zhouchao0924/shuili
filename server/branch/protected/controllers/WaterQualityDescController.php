 ...
 * Time: 13:06
 */
class WaterQualityDescController extends Controller{
    /**
     * 导入
     * @return string
     */
    public function actionImport(){
        ...
        try {
            ...
            $excel = new ExcelTemplateModel(new WaterQualityDescExcelTemplateConfig());
            $extra = array(
    ...
    public function actionGetList(){
        ...
        $excelModel = new ExcelTemplateModel(new WaterQualityDescExcelTemplateConfig());
        $client = new ClientComponent();
