 ...
 * Time: 13:06
 */
class PumpingStationController extends Controller{
    /**
     * 导入
     * @return string
     */
    public function actionImport(){
        ...
        try {
            ...
            $excel = new ExcelTemplateModel(new PumpingStationExcelTemplateConfig());
            $extra = array(
    ...
    public function actionGetList(){
        ...
        $excelModel = new ExcelTemplateModel(new PumpingStationExcelTemplateConfig());
        $client = new ClientComponent();
