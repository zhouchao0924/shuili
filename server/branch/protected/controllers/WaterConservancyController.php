 ...
 * Time: 13:06
 */
class WaterConservancyController extends Controller{
    /**
     * 导入
     * @return string
     */
    public function actionImport(){
        ...
        try {
            ...
            $excel = new ExcelTemplateModel(new WaterConservancyExcelTemplateConfig());
            $extra = array(
    ...
    public function actionGetList(){
        ...
        $excelModel = new ExcelTemplateModel(new WaterConservancyExcelTemplateConfig());
        $client = new ClientComponent();
