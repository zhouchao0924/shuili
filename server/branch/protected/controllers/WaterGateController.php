 ...
 * Time: 13:06
 */
class WaterGateController extends Controller{
    /**
     * 导入
     * @return string
     */
    public function actionImport(){
        ...
        try {
            ...
            $excel = new ExcelTemplateModel(new WaterGateExcelTemplateConfig());
            $extra = array(
    ...
    public function actionGetList(){
        ...
        $excelModel = new ExcelTemplateModel(new WaterGateExcelTemplateConfig());
        $client = new ClientComponent();
